  ...
  return (
    <footer className="bg-blue-900 text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="col-span-1 md:col-span-2">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-xl font-bold">TK Ceria Mandiri</span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-blue-200">
            ...
            <li><a href="#" className="hover:text-white transition">Jadwal Akademik</a></li>
            <li><a href="#" className="hover:text-white transition">Berita & Artikel</a></li>
            <li><a href="#" className="hover:text-white transition">Karir Guru</a></li>
          </ul>
        </div>
        <div>
      ...
      <div className="max-w-7xl mx-auto px-4 border-t border-blue-800 pt-8 text-center text-blue-300 text-sm">
        <p>&copy; 2024 TK Ceria Mandiri. Hak Cipta Dilindungi.</p>
      </div>
    </footer>
  );
};
